...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-WowDsgn/MonkeyKing.framework"
  install_framework "Pods-WowDsgn/Moya.framework"
  install_framework "Pods-WowDsgn/ObjectMapper.framework"
  install_framework "Pods-WowDsgn/PonyFrameworkOnSwift.framework"
  install_framework "Pods-WowDsgn/ReachabilitySwift.framework"
  install_framework "Pods-WowDsgn/Result.framework"
  install_framework "Pods-WowDsgn/RxSwift.framework"
