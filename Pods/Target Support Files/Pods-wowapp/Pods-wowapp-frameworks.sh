...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "$BUILT_PRODUCTS_DIR/StyleKit/StyleKit.framework"
  ...
  install_framework "$BUILT_PRODUCTS_DIR/WowBase/WowBase.framework"
  install_framework "$BUILT_PRODUCTS_DIR/XZMRefresh/XZMRefresh.framework"
  install_framework "$BUILT_PRODUCTS_DIR/YTKKeyValueStore_Swift/YTKKeyValueStore.framework"
