...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "$BUILT_PRODUCTS_DIR/MoyaX/MoyaX.framework"
  ...
  install_framework "$BUILT_PRODUCTS_DIR/WowUI/WowUI.framework"
  install_framework "$BUILT_PRODUCTS_DIR/WowWebService/WowWebService.framework"
