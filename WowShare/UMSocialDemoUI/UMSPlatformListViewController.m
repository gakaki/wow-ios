...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    frame.origin.x = cell.textLabel.frame.origin.x + cell.textLabel.frame.size.width - frame.size.width - 20.f;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    __weak UMSPlatformListViewController *ws = self;
    [[UMSocialManager defaultManager] getUserInfoWithPlatform:obj.platform currentViewController:nil completion:^(id result, NSError *error) {
        ...
        if (error) {
            ...
            if ([result isKindOfClass:[UMSocialUserInfoResponse class]]) {
                ...
                [ws.navigationController pushViewController:[UMSAuthDetailViewController detailVCWithInfo:obj] animated:YES];
