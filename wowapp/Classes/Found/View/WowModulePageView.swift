...
//302 二级分类
class MODULE_TYPE_CATEGORIES_MORE_CV_CELL_302:UITableViewCell,ModuleViewElement{
    static func isNib() -> Bool { return false }

}

//401 本周上新
class MODULE_TYPE_NEW_ARRIVAL_RPODUCTS_CV_CELL_401:UITableViewCell,ModuleViewElement{
    static func isNib() -> Bool { return false }
...
struct ModulePageType {
    ...
    static let d = [
        ...
        PAGE_MODULE_TYPE_NEW_ARRIVAL_RPODUCTS 		: MODULE_TYPE_NEW_ARRIVAL_RPODUCTS_CV_CELL_401.classForCoder(),     //401 本周上新
