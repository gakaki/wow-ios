//
//  WOWProductSpecLayout.swift
//  wowapp
//
//  Created by 安永超 on 16/10/9.
//  Copyright © 2016年 小黑. All rights reserved.
//

import UIKit

class WOWProductSpecLayout: UICollectionViewFlowLayout {
    override func prepare() {
        
        super.prepare()
        
        //cell数据离头距离
        self.sectionInset = UIEdgeInsetsMake(0, 0, 10, 0)
        //每组头的大小
        //        self.headerReferenceSize = CGSizeMake(MGScreenWidth, 35)
        //        self.footerReferenceSize = CGSizeMake(MGScreenWidth, 35)
