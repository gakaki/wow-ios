...
open class NHRangeSliderView: UIView {
    ...
    //    @IBInspectable open var dataArray: Array? = nil {
    //        didSet {
    //            self.rangeSlider?.stepValue = stepValue
    //        }
    //    }
    ...
    @IBInspectable open var thumbSize: CGFloat = 26.0 {
        didSet {
    ...
    open func setup() {
        ...
        self.lowerLabel?.font = UIFont.systemFont(ofSize: 12.0)
        ...
        self.upperLabel?.font = UIFont.systemFont(ofSize: 12.0)
