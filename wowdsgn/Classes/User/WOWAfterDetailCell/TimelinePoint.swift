...
//
//  Created by Zheng-Xiang Ke on 2018/10/20.
//  Copyright © 2018年 Zheng-Xiang Ke. All rights reserved.
//

import Foundation
import UIKit
public let radiusDefault: CGFloat = 8.0
public struct TimelinePoint {
    public var diameter: CGFloat = radiusDefault {
        didSet {
            if (diameter < 0.0) {
                diameter = 0.0
    ...
    public init() {
        self.init(diameter: radiusDefault, lineWidth: 2.0, color: UIColor.black, filled: false)
    }
