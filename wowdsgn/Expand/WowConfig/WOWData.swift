...
let WOWConstellation:[String] = ["白羊座","金牛座","双子座","巨蟹座","狮子座","处女座","天秤座","天蝎座","射手座","摩羯座","水瓶座","双鱼座"]   //下标从1开始

let WOWAgeRange:[String] = ["保密", "60后", "70后", "80后", "85后", "90后", "95后", "00后"]      //下标从0开始

let WOWSex:[String] = ["男","女","保密"]    //下标从1开始
